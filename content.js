const categories = {
  ...
  "Advisor": {
    "keywords": [
      ...
      "মৎস্য উপদেষ্টা", "পরিবেশ উপদেষ্টা", "রাজনীতিবিদ","সচিব","সরকার","সংস্কার","স্বরাষ্ট্র উপদেষ্টা","তথ্যপ্রযুক্তিউপদেষ্টা","তথ্যপ্রযুক্তিউপদেষ্টা","সংস্কৃতি বিষয়ক উপদেষ্টা","পররাষ্ট্র উপদেষ্টা","খাদ্য উপদেষ্টা","উপদেষ্টা মাহফুজ আলম।","অর্থ উপদেষ্টা","বাণিজ্য উপদেষ্টা","অন্তর্বর্তী সরকার","নৌপরিবহন উপদেষ্টা","তথ্য উপদেষ্টা"
    ]
  },
  "Law and Order": {
    "keywords": [
